...
vec3 calcPointLightDiffuse(PointLightUBO light, vec3 tex, vec3 normal) {
...
float calcShadowUBO(vec3 lightPos, samplerCube map) {
...
vec3 calcUBOPointLight(PointLightUBO light, vec3 tex, vec3 normal) {
